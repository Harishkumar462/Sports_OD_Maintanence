...
<body>
<ul>
<li><a href="principalstatus.jsp">STATUS</a></li>
<li><a href="princhangepass.jsp">CHANGE PASSWORD</a></li>
...
ResultSet rs=st1.executeQuery("select * from od where prin='0'");
%>
<center>
<table>
<tr>
...
<td>
<%String link="principalvali.jsp?id="+rs.getString(2)+"1"+rs.getString(5); %>
<a href="<%out.print(link); %>">
<strong>ACCEPT</strong>
</a>
</td>
<td>
<%String link1="principalvali.jsp?id="+rs.getString(2)+"0"+rs.getString(5); %>
